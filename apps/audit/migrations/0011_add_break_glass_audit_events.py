# Generated manually for break-glass login audit events
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('audit', '0010_alter_auditlog_event'),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ('document.bulk_uploaded', 'Document Bulk Uploaded'),
                    ('document.bulk_reviewed', 'Bulk Upload Reviewed'),
                    ('document.preview_queued', 'Document Preview Queued'),
                    ('document.ocr_queued', 'Document OCR Queued'),
                    ('document.ocr_completed', 'Document OCR Completed'),
                    ('document.ocr_failed', 'Document OCR Failed'),
                    ('document.edit_lock_acquired', 'Document Edit Lock Acquired'),
                    ('document.edit_lock_released', 'Document Edit Lock Released'),
                    ...
                    ('document.version_preview_queued', 'Document Version Preview Queued'),
                    ('user.login', 'User Login'),
                    ('user.login_failed', 'Login Failed'),
                    ('user.break_glass_login', 'Break-Glass Login (Emergency Native Auth)'),
                    ('user.break_glass_login_failed', 'Break-Glass Login Failed'),
                    ...
                    ('group.permission_granted', 'Group Permission Granted'),
                    ('group.permission_revoked', 'Group Permission Revoked'),
